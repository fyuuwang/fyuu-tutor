...
def main() -> int:
    ...
    markers_path = workspace / cfg["marker_file"]
    markers: list[str] = []
    if markers_path.is_file():
        markers = [line.strip() for line in markers_path.read_text(encoding="utf-8").splitlines()
